  ...
  },
{
    ...
    listingDetails: "Transmission not confirmed — check the ad.",
  ...
  },
{
    ...
    listingDetails: "Full service history · verified history · 1-year dealer warranty · gearbox and NCT not shown · tax estimated Transmission not confirmed — check the ad.",
  }
];
